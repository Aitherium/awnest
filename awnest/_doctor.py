...
interesting failures live BETWEEN them. "awnest is installed" is not the useful
fact -- "awnest is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awnest'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awbac', 'awdit', 'adk', 'awgit', 'awiam', 'awnet', 'awrelay', 'awseal', 'awtunnel']
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWNEST_JUDGE_TOKEN']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awnest needs at runtime, and a
